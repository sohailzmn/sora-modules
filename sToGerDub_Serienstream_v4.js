...
async function __stoRequestText(url, options) {
  ...
  try {
    ...
    try {
      ...
      console.log("[s.to serienstream v4] request failed:", url, e2);
      return "";
    }
  }
...
async function __stoEnsureBase() {
  ...
  __stoLoading = (async function () {
    try {
      ...
      console.log("[s.to serienstream v4] original module loaded:", __stoLoaded);
      return __stoLoaded;
    } catch (error) {
      console.log("[s.to serienstream v4] base load error:", error);
      return false;
    } finally {
      __stoLoading = null;
    }
...
async function searchResults(keyword) {
  try {
    console.log("[s.to serienstream v4] searching:", keyword);
    ...
    console.log("[s.to serienstream v4] search results:", results.length);
    return JSON.stringify(results);
  } catch (error) {
    console.log("[s.to serienstream v4] search error:", error);
...
async function extractDetails(url) {
  try {
    ...
    console.log("[s.to serienstream v4] details error:", error);
...
async function extractEpisodes(url) {
  try {
    ...
    console.log("[s.to serienstream v4] episodes error:", error);
    return JSON.stringify([]);
  }
}
...
function extractStreamUrl(html) {
  try {
    ...
    console.log("[s.to serienstream v4] stream error:", error);
    return JSON.stringify([]);
  }
}
